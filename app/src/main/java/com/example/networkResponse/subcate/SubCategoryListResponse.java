package com.example.networkResponse.subcate;
...
public class SubCategoryListResponse implements Serializable {
    ...
    public SubCategoryListResponse(List<SubCategory> subCategoryList, String message, String status) {
    ...
    public class SubCategory {
        ...
        public SubCategory(String subCategoryId, String categoryId, String subcategoryName, String subcategoryStatus) {
